...
public class ReplaceNodesWithDepth {
    ...
    public static void changeToDepthTree(BinaryTreeNode<Integer> root) {
        changeToDepthHelper(root,0);
    }

    public static void changeToDepthHelper(BinaryTreeNode<Integer> root,int depth) {
        if(root==null){
            return;
        }
        root.data=depth;
        changeToDepthHelper(root.left,depth+1);
        changeToDepthHelper(root.right,depth+1);
    }
